...
an example of commands to build the image and then to run your container locally and access the notebook:
```bash
...
You will also find the two images distributed with the deepdream repository. Finally, in "notebooks/models", you will find GoogleNet architecture and weights ready 
